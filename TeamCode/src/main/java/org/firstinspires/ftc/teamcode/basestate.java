...
public class BaseStateMachineOpMode extends BaseOpMode {
    ...
    final PathSeg[] mNextWallPath1 = {
            new PathSeg(3.4, -3.4, 0.3),

    };

    final PathSeg[] mNextWallPath2 = {
            new PathSeg(3.4, -3.4, 0.3),

    };

    final PathSeg[] mNextWallPath3 = {
            new PathSeg(3.4, -3.4, 0.3),
    ...
    PathSeg[] getNextWallPath() {
        if (goldPosition == StateMachineExample.GoldPosition.ONE) {
            return(mNextWallPath1);
        } else if (goldPosition == StateMachineExample.GoldPosition.TWO) {
            return(mNextWallPath2);
        } else {
            return(mNextWallPath3);
        }
    }
    ...
    void initStateMachine() {
        ...
        StateDriveToNextWall driveToNextWall = new StateDriveToNextWall();
        ...
        deployTeamMarker.setNextState(driveToNextWall);
        driveToNextWall.setNextState(stop);

        stateMachine = new StateMachine(initialState);
    }
    class StateDriveToNextWall extends BasePathState {
        @Override
        PathSeg[] getPath() { return getNextWallPath(); }
    }
